...
const $form = document.querySelector('form'); // Previene que el from se submitee y nos recargue la página
...
$calcularSalario.addEventListener('click',manejarClickCalcular);
